...
def show_login_page():
    ...
    # Login/Register tabs
    tab1, tab2, tab3 = st.tabs(["👨‍🌾 Admin Login", "🛒 Customer Login", "📝 Register"])
    ...
    with tab1:
        ...
        with st.form("admin_login"):
            email = st.text_input("Email", placeholder="admin@farm.com")
        ...
        st.info("💡 Default admin credentials: john@greenvalley.com / admin123")
